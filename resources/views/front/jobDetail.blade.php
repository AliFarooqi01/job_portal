                    ...
                    <div class="card shadow border-0">
                        ...
                        <div class="descript_wrap white-bg">
                            ...
                            <div class="pt-3 text-end">
                                ...
                                @endif
                                @if (Auth::check())
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#applyJobModal"
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <div class="alert alert-danger">
                                                        <strong>Sorry!</strong> Application is not found
                                                    </div>
                                                </td>
                                            </tr>
                                        @endif
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="default-form job-apply-form" id="jobApplyForm" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="upload" class="form-label">Upload CV (doc, docx, pdf)</label>
                            <input class="form-control" accept="image/*, application/pdf" id="upload" required
                        ...
                        <button type="submit" class="btn btn-primary w-100" name="submit-form">Apply Job</button>
                    </form>
                </div>
            </div>
        </div>
...
@section('customJs')
    <script type="text/javascript">
        $('#jobApplyForm').on('submit', function(event) {
