            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body card-form p-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input value="{{ $job->vacancy }}" type="number" min="1"
                                                    placeholder="Vacancy" id="vacancy" name="vacancy"
                                                    class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="mb-4 col-md-6">
                                                <div class="form-check">
                                                    <input {{ ($job->isFeatured == 1 ? 'checked' : '') }} class="form-check-input" type="checkbox" value="1"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="experience" id="experience" class="form-control">
                                                ...
                                                <option value="fresher"
                                                    {{ $job->experience == 'fresher' ? 'selected' : '' }}>
                                                    Fresher</option>
                                                @for ($i = 1; $i <= 10; $i++)
                                                    <option value="{{ $i }}"
                                                        {{ $job->experience == $i ? 'selected' : '' }}>{{ $i }}
                                                        Years
                                                    </option>
                                                @endfor
                                                <option value="10_plus"
                                                    {{ $job->experience == '10_plus' ? 'selected' : '' }}>10+
                                                    Years</option>
                                            </select>
                                        </div>
                                        <div class="mb-4">
